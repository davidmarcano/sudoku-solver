...
bool PuzzleClass::Checker(int NumbersSeenArray[]&, int ArraySize, PuzzleClass PuzzleArray, int i, int j) {
	for (; i < ArraySize; ++i){
...
void PuzzleClass::PossibilityInitializer() {
	for (int k = 0; k < ArraySize; ++k) {
		PuzzleArray[i][k].PuzzleSquareClass::SetPossibilities(NumbersSeenArray, k);
	}	
}
